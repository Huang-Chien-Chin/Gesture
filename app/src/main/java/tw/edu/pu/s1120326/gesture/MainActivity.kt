package tw.edu.pu.s1120326.gesture
...
import tw.edu.pu.s1120326.gesture.ui.theme.GestureTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            tw.edu.pu.s1120326.gesture.ui.theme.GestureTheme() {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    //PointerEvents()
                    tw.edu.pu.s1120326.gesture.Tap()
                    Drag_Horizontal()
                    Drag_Vertical()
                    ghost ()
...
@Composable
fun PointerEvents() {
    var msg by remember { mutableStateOf("作者：黃千津") }
    Column {
        Text("\n" + msg)
        Box(
            Modifier
